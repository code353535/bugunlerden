import { b as createAstro, c as createComponent, r as renderTemplate, m as maybeRenderHead, s as spreadAttributes, e as addAttribute, d as renderComponent, u as unescapeHTML, F as Fragment, a as renderHead, l as renderSlot } from './astro/server_74aKCQZx.mjs';
import 'kleur/colors';
/* empty css                        */
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<!--[--><button aria-label="Menüyü Aç/Kapat" class="flex items-center" data-v-7d7c33e2><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="w-7 h-7 text-black dark:text-white" data-v-7d7c33e2><path d="M4 6h16M4 12h16M4 18h16" stroke-linecap="round" stroke-linejoin="round" data-v-7d7c33e2></path></svg></button>`);
  if ($setup.MobilMenu) {
    _push(`<div class="fixed inset-0 z-50 flex" data-v-7d7c33e2><div class="bg-[#fff] dark:bg-black text-black dark:text-gray-100 w-full p-4" data-v-7d7c33e2><div class="flex justify-between border-b border-[#e6e6e5] dark:border-[#2d2d2d]" data-v-7d7c33e2><div class="pb-4 flex flex-row items-center min-h-12" data-v-7d7c33e2><span class="baslik text-xl font-black whitespace-nowrap animate-charcter" data-v-7d7c33e2> BUGUNLERDE </span></div><div data-v-7d7c33e2><button class="text-black focus:outline-none mb-4" data-v-7d7c33e2><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="font-bold w-6 h-6 text-black dark:text-gray-100" data-v-7d7c33e2><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-7d7c33e2></path></svg></button></div></div><nav class="mt-6 text-black dark:text-gray-100" data-v-7d7c33e2><!--[-->`);
    ssrRenderList($setup.categories, (category) => {
      _push(`<div data-v-7d7c33e2><div class="group mb-4 mx-2 mt-6" data-v-7d7c33e2><div class="flex items-center cursor-pointer" data-v-7d7c33e2><span class="flex text-lg tracking-wide font-bold uppercase" data-v-7d7c33e2>`);
      if (category.subcategories.length === 0) {
        ...
        _push(`<span data-v-7d7c33e2><div class="flex items-center" data-v-7d7c33e2>${
          ssrInterpolate(category.name)
        } <svg xmlns="http://www.w3.org/2000/svg" class="${
          ssrRenderClass([{'rotate-180': $setup.selectedCategory === category.id}, "ml-2 w-5 h-5 transition-transform"])
        }" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" data-v-7d7c33e2><path d="M19 9l-7 7-7-7" data-v-7d7c33e2></path></svg></div></span>`);
      }
      _push(`</span></div>`);
      if ($setup.selectedCategory === category.id) {
        _push(`<div class="mt-4 font-bold tracking-wide text-lg uppercase" data-v-7d7c33e2><!--[-->`);
        ssrRenderList(category.subcategories, (subcategory, index) => {
          _push(`<div style="${
            ssrRenderStyle({ animationDelay: `${index * 0.1}s` })
          }" class="subcategory-item mb-3" data-v-7d7c33e2><a${
            ssrRenderAttr("href", `/category/${subcategory.slug}`)
          } class="flex items-center px-4 text-lg font-bold uppercase" data-v-7d7c33e2>${
    ...
    _push(`<!--]--></nav></div><div class="flex-grow" data-v-7d7c33e2></div></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<!--]-->`);
...
const $$GoogleAnalytics = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<head><script type="text/partytown"', '><\/script><script type="text/partytown"', " id=\"ga-init\">\n        {`\n            const measurementId = document\n                .getElementById('ga-init')\n                .getAttribute('data-ga-measurement-id');\n            window.dataLayer = window.dataLayer || [];\n            function gtag() {\n                dataLayer.push(arguments); // eslint-disable-line\n            }\n            gtag('js', new Date());\n            gtag('config', measurementId);\n        `}\n    <\/script>", "</head>"], ['<head><script type="text/partytown"', '><\/script><script type="text/partytown"', " id=\"ga-init\">\n        {\\`\n            const measurementId = document\n                .getElementById('ga-init')\n                .getAttribute('data-ga-measurement-id');\n            window.dataLayer = window.dataLayer || [];\n            function gtag() {\n                dataLayer.push(arguments); // eslint-disable-line\n            }\n            gtag('js', new Date());\n            gtag('config', measurementId);\n        \\`}\n    <\/script>", "</head>"])), addAttribute(`https://www.googletagmanager.com/gtag/js?id=${measurementId}`, "src"), addAttribute(measurementId, "data-ga-measurement-id"), renderHead());
}, "/var/www/html/bugunlerden/src/components/GoogleAnalytics.astro", undefined);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="tr"> <head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>${title} | Bugunlerde.com</title><meta name="description"${addAttribute(description, "content")}><meta name="theme-color" content="#141414">${renderComponent($$result, "GoogleAnalytics", $$GoogleAnalytics, { "measurementId": "G-4RSCMSGK57" })}<!-- Open Graph Meta Etiketleri --><meta property="og:title"${addAttribute(title, "content")}><meta property="og:description"${addAttribute(description, "content")}><meta property="og:url"${addAttribute(slug, "content")}><meta property="og:image"${addAttribute(image, "content")}><meta property="og:type" content="article"><!-- Twitter Card Etiketleri --><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title"${addAttribute(title, "content")}><meta name="twitter:description"${addAttribute(description, "content")}><meta name="twitter:image"${addAttribute(image, "content")}><link rel="sitemap" href="/sitemap-index.xml"><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="apple-touch-icon" href="/apple-icon.png"><link rel="icon" sizes="192x192" href="/android-chrome-192x192.png"><link rel="icon" sizes="192x192" href="/android-chrome-512x512.png"><link rel="icon" sizes="16x16" href="/favicon-16x16.png"><link rel="icon" sizes="32x32" href="/favicon-32x32.png">${renderHead()}</head> <body> <div id="sayfa"> ${renderComponent($$result, "Header", $$Header, {})} <div class="max-w-screen-xl mx-auto"> ${renderSlot($$result, $$slots["default"])} </div> ${renderComponent($$result, "Footer", $$Footer, {})} </div> </body></html>`;
